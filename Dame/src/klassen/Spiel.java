...
public class Spiel implements iBediener, Serializable {
	...
	public void addSpieler(String name, FarbEnum farbe, String KI) {
		...
		if (spielerAnz == 1) {
			Spieler sp = new Spieler(name, farbe, this.bestimmeKI(KI));
	...
	// System.out.println("Hohohohohohohohohoh" +
	// spielbrett.getFelder()[i][j].getFigur());
	//
	//
	//
	//
