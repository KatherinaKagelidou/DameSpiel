...
public class Spieler2AuswahlDialog extends JOptionPane  implements Serializable {
	...
	private void erstelle() {
		...
		spielerText = new JLabel("Spieler 2");
		...
		int farbeLoeschen = spieler1AuswahlDialog.getFarbAuswahl().getSelectedIndex();
		farbAuswahl.removeItemAt(farbeLoeschen);
